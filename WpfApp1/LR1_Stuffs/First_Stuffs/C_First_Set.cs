...
namespace WpfApp1.LR1_Stuffs.First_Stuffs
{
    class C_First_Set
    {
        ...
        public bool first_set_match(List<C_First_Element> a_first_set) {
            ...
            for (int index = 0; index < length; index++) { //Ambos contienen los mismos conjuntos, en principio podemos usar el mismo indice para hacer el recorrido.
                ...
                if (lenght_lists != foreign_first_element.First.Count) { //Los indices no coinciden. Los conjuntos son diferentes.
                    return false;
                }
                else { //Los indices son iguales, verificamos que el contenido sea el mismo.
        ...
        public void copy_Set_Firts_on_self(List<C_First_Element> list_first_element) {
            ...
            if(lenght_list == list_first_element.Count) { //Si la longitud es la misma entre listas, todo chingon!, podemos copiar.
